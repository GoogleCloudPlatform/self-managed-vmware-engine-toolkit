...
# ==============================================================================
# File: infrastructure/modules/jumpbox/outputs.tf
# Description: Output values for the Jumpbox submodule.
# ==============================================================================
...
output "internal_ip" {
  description = "The internal private IPv4 address of the jumpbox VM."
