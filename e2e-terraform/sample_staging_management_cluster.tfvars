...
#     or an IPv4 range string (e.g., { "vcf-service-runtime" = "10.250.0.50-10.250.0.80" }) which automatically expands into sequential entries.
...
mgmt_ip_values = {
  ...
  "vsp01"     = "10.250.0.50-10.250.0.80" # VCF Service Runtime Platform IP Pool
  ...
  # "vcf-automation-node-ips" = "10.250.0.81-10.250.0.86" # VCF Automation Cluster Node IP Pool (6 nodes, required if and only if VCF Automation is deployed)
  ...
  # "nsx-edge-0" = "10.250.0.26" # NSX Edge Node 1 Management Interface (Required if and only if NSX Edge appliance is being deployed)
  # "nsx-edge-1" = "10.250.0.27" # NSX Edge Node 2 Management Interface (Required if and only if NSX Edge appliance is being deployed)
}
...
nsx_ip_values = {
  ...
  # "nsx-edge-vip"      = "10.250.3.10" # NSX Edge Cluster Uplink Virtual Floating IP (Required iff NSX Edge is deployed)
  # "nsx-edge-0-uplink" = "10.250.3.11" # NSX Edge Node 1 External BGP/Uplink IP (Required iff NSX Edge is deployed)
  # "nsx-edge-0-tep"    = "10.250.3.12" # NSX Edge Node 1 Geneve Overlay Tunnel Endpoint (TEP) (Required iff NSX Edge is deployed)
  # "nsx-edge-1-uplink" = "10.250.3.13" # NSX Edge Node 2 External BGP/Uplink IP (Required iff NSX Edge is deployed)
  # "nsx-edge-1-tep"    = "10.250.3.14" # NSX Edge Node 2 Geneve Overlay Tunnel Endpoint (TEP) (Required iff NSX Edge is deployed)
}
