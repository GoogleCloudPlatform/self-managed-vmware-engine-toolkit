...
esxi_image = "projects/gcve-bcom-vvol-project/global/images/vmware-esxi-9-1-0-v20260730"
...
availability_domains    = [1] # Explicit or round-robin availability domain mapping
...
mgmt_ip_values = {
  ...
  "sddc-manager"        = "10.250.0.10" # SDDC Manager Virtual Appliance
  ...
  "vcf-service-runtime1" = "10.250.0.19" # VCF Service Runtime Platform
  ...
  "vcfautomation" = "10.250.0.20" # VMware Aria Automation Core Appliance
  "vcfruntime"    = "10.250.0.21" # VMware Aria Automation Orchestrator Runtime
  ...
  "nsx-4"     = "10.250.0.23" # NSX Manager Node 3 Management IP
  "nsx-edge4" = "10.250.0.26" # NSX Edge Node 1 Management Interface
  "nsx-edge5" = "10.250.0.27" # NSX Edge Node 2 Management Interface
}

# NSX Datapath & Edge Node IP Allocation Mode & Static IP Mappings
nsx_ip_address_type = "reserved_custom"
nsx_ip_values = {
  "uplink-vip-ip"         = "10.250.3.10" # NSX Edge Cluster Uplink Virtual Floating IP
  "edge-node-1-uplink-ip" = "10.250.3.11" # NSX Edge Node 1 External BGP/Uplink IP
  "edge-node-1-tep-ip"    = "10.250.3.12" # NSX Edge Node 1 Geneve Overlay Tunnel Endpoint (TEP)
  "edge-node-2-uplink-ip" = "10.250.3.13" # NSX Edge Node 2 External BGP/Uplink IP
  "edge-node-2-tep-ip"    = "10.250.3.14" # NSX Edge Node 2 Geneve Overlay Tunnel Endpoint (TEP)
}
