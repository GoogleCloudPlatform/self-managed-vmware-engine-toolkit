...
>>>>>>> 71b44cd (e2e-terraform, vcf_deployer: Provision NTP DNS A record and configure NTP FQDN for VCF installer)
# Valid Values: true, false
# Default Value: true (Optional)
...
# Default Value: None (Required)
esxi_image = "projects/<YOUR_IMAGE_PROJECT_ID>/global/images/vmware-esxi-9-1-0-v20260730" # TODO(tulippandey) Change this once public qualified images are available
...
#     to static IPv4 addresses within the subnetwork CIDR (e.g., { "vc01" = "10.250.0.11", "collector" = "10.250.0.10" }),
#     or an IPv4 range string (e.g., { "vsrt" = "10.250.0.51-10.250.0.80" }) which automatically expands into sequential entries.
...
mgmt_ip_values = {
  ...
  "sddcm"     = "10.250.0.9"              # VCF SDDC Manager Appliance
  "collector" = "10.250.0.10"             # VMware Cloud Proxy Appliance
  "vc01"      = "10.250.0.11"             # Management vCenter Server Appliance (VCSA)
  "license"   = "10.250.0.16"             # VCF License Manager Service
  "shared01"  = "10.250.0.17"             # VCF Instance Service Manager
  "vidb"      = "10.250.0.18"             # VMware Workspace ONE Access / Identity Broker
  "vsp01"     = "10.250.0.50"             # VCF Services Runtime Platform
  "vsrt"      = "10.250.0.51-10.250.0.62" # VCF Services Runtime IP Pool

  # VMware Aria Suite Operations & Automation Services
  "ops01"    = "10.250.0.12" # VMware Aria Operations Primary Node
  "ops02"    = "10.250.0.24" # VMware Aria Operations Replica Node
  "ops03"    = "10.250.0.25" # VMware Aria Operations Data Node
  "fleetlcm" = "10.250.0.13" # VMware Aria Operations Fleet Management Service
  # "auto-vip"      = "10.250.0.20"             # VCF Automation Appliance VIP (Required if and only if VCF Automation deployment is intended)
  # "auto-platform" = "10.250.0.21"             # VCF Automation Runtime (Required if and only if VCF Automation deployment is intended)
  # "auto-node"     = "10.250.0.81-10.250.0.85" # VCF Automation Cluster Node IP Pool (5 nodes, required if and only if VCF Automation is deployed)

  # NSX Management Cluster & Management Interfaces
  "nsx01" = "10.250.0.14" # NSX Management Cluster Floating Virtual IP (VIP)
  "nsx02" = "10.250.0.15" # NSX Manager Node 1 Management IP
  "nsx03" = "10.250.0.22" # NSX Manager Node 2 Management IP
  "nsx04" = "10.250.0.23" # NSX Manager Node 3 Management IP
  # "nsx-edge01" = "10.250.0.26" # NSX Edge Appliance 1 Management Interface (Required if and only if NSX Edge appliance is being deployed)
  # "nsx-edge02" = "10.250.0.27" # NSX Edge Appliance 2 Management Interface (Required if and only if NSX Edge appliance is being deployed)
}
...
nsx_ip_values = {
  ...
  # "nsx-uplink-vip"    = "10.250.3.10" # NSX Edge Cluster Uplink Virtual Floating IP (Required iff NSX Edge is deployed)
  # "nsx-uplink-edge01" = "10.250.3.11" # NSX Edge 1 External BGP/Uplink IP (Required iff NSX Edge is deployed)
  # "nsx-tep-edge01"    = "10.250.3.12" # NSX Edge 1 Geneve Overlay Tunnel Endpoint (TEP) (Required iff NSX Edge is deployed)
  # "nsx-uplink-edge02" = "10.250.3.13" # NSX Edge 2 External BGP/Uplink IP (Required iff NSX Edge is deployed)
  # "nsx-tep-edge02"    = "10.250.3.14" # NSX Edge 2 Geneve Overlay Tunnel Endpoint (TEP) (Required iff NSX Edge is deployed)
}
